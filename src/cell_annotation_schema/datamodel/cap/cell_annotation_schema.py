...
class CapAnnotation(Annotation):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://w3id.org/Cellular-Semantics/General-Cell-Annotation-Open-Standard/CapAnnotation")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Cap_Annotation"
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/Cellular-Semantics/General-Cell-Annotation-Open-Standard/CapAnnotation")
...
class CapTaxonomy(Taxonomy):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://w3id.org/Cellular-Semantics/General-Cell-Annotation-Open-Standard/CapTaxonomy")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Cap_Taxonomy"
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/Cellular-Semantics/General-Cell-Annotation-Open-Standard/CapTaxonomy")
