# Contributing to cell-annotation-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cell-annotation-schema. These guidelines are not strict rules.
...
The cell-annotation-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cell-annotation-schema technical leads
...
[issues]: https://github.com/Cellular-Semantics/cell-annotation-schema/issues/
[pulls]: https://github.com/Cellular-Semantics/cell-annotation-schema/pulls/
